...
Namespace DataImportExample
	Partial Public Class Form1
		...
		Private Sub ImportArrayList(ByVal worksheet As Worksheet)
			Dim listDataSource As System.Collections.ArrayList = (New TestObject(1, "Jane", True, imageBytes1), New TestObject(2, "Joe", False, imageBytes2), New TestObject(3, "Bill", True, imageBytes1), New TestObject(4, "Michael", False, imageBytes2),)
...
'			#Region "#ImportSpecifiedFields"
			...
			Dim list As List(Of TestObject) = (New TestObject(1, "1", True, imageBytes1), New TestObject(2, "2", False, imageBytes2))
...
'			#Region "#ImportUsingConverter"
			...
			Dim list As List(Of TestObject) = (New TestObject(1, "1", True, imageBase64), New TestObject(2, "2", False, imageBase64))
			worksheet.Import(list, 0, 0, New DataSourceImportOptions() With {
